...
const LOCAL_PREFS_STORAGE_KEY = "neonanobot-webui.settings-preferences";
        ...
        <div className="overflow-hidden rounded-[22px] border border-border/45 bg-card/86 shadow-[0_18px_65px_rgba(15,23,42,0.075)] backdrop-blur-xl dark:border-white/10 dark:shadow-[0_18px_65px_rgba(0,0,0,0.24)]">
          <div className="flex flex-col gap-4 px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-center gap-3">
              <NanobotBrandLogo size="lg" testId="overview-neonanobot-logo" />
              <div className="min-w-0">
                <div className="text-[12px] font-medium text-muted-foreground">neonanobot</div>
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <p className="max-w-[680px] text-[13px] leading-5 text-muted-foreground">
            {tx(
              ...
              "Add local app adapters and connected tool servers that neonanobot can use from chat.",
            )}
          </p>
  ...
  return (
    <div className="space-y-7">
      <section>
        ...
        <SettingsGroup>
          <SettingsRow title={tx("settings.rows.botName", "Bot name")} description={tx("settings.help.botName", "Shown wherever neonanobot uses a display name.")}>
            <Input
              value={form.botName}
          ...
          <RestartSettingsFooter
            ...
            dirtyMessage={
              isNativeHost
                ? tx("settings.status.hostRestartAfterSaving", "Save changes and neonanobot will restart its engine.")
                : tx("settings.status.restartAfterSaving", "Save changes, then restart when ready.")
            }
            pendingMessage={
              isNativeHost
