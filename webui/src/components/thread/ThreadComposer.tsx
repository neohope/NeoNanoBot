...
const SLASH_RECENTS_STORAGE_KEY = "neonanobot.webui.slashCommandRecents";
const SLASH_RECENTS_LIMIT = 5;
const QUEUED_PROMPTS_STORAGE_PREFIX = "neonanobot.webui.composerQueuedGuidance.v1:";
  ...
  return (
    ...
    >
      {goalPanelOpen && canExpandGoal && markdownBody ? (
        <div
          ref={panelRef}
          id="neonanobot-goal-panel-root"
          role="dialog"
          aria-modal="false"
          aria-labelledby="neonanobot-goal-panel-title"
          tabIndex={-1}
          className={cn(
        ...
        >
          <div className="flex shrink-0 items-center justify-between gap-2 border-b border-black/[0.06] px-3 py-2 dark:border-white/[0.08]">
            <h2
              id="neonanobot-goal-panel-title"
          ...
          <div
            id="neonanobot-goal-panel-scroll"
      ...
      >
        ...
        {canExpandGoal ? (
          <button
            ...
            aria-controls={goalPanelOpen ? "neonanobot-goal-panel-root" : undefined}
