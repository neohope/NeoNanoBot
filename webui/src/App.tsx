...
import { NanobotClient } from "@/lib/neonanobot-client";
...
const SIDEBAR_STORAGE_KEY = "neonanobot-webui.sidebar";
const COMPLETED_RUNS_STORAGE_KEY = "neonanobot-webui.sidebar.completed-runs.v1";
const RESTART_STARTED_KEY = "neonanobot-webui.restartStartedAt";
