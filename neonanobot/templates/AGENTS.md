...
Use the built-in `cron` tool to create/list/remove jobs (do not call `neonanobot cron` via `exec`).
Get USER_ID and CHANNEL from the current session (e.g., `8281248569` and `feishu` from `feishu:ou8281248569`).
