...
from neonanobot.agent.runner import AgentRunner, AgentRunSpec
from neonanobot.agent.tools.registry import ToolRegistry
from neonanobot.session.manager import Session
from neonanobot.utils.gitstore import GitStore
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from neonanobot.agent.tools.file_state import FileStates
        from neonanobot.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
