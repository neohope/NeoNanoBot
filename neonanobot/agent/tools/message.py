...
from neonanobot.agent.tools.context import ContextAware, RequestContext
from neonanobot.agent.tools.path_utils import resolve_workspace_path
from neonanobot.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from neonanobot.security.workspace_access import current_tool_workspace
from neonanobot.bus.events import OutboundMessage
from neonanobot.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from neonanobot.utils.helpers import strip_think
