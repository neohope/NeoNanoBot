...
from neonanobot.agent.tools.base import Tool, tool_parameters
from neonanobot.agent.tools.context import current_request_session_key
from neonanobot.agent.tools.exec_session import (
...
from neonanobot.agent.tools.sandbox import wrap_command
...
from neonanobot.config.paths import get_media_dir
from neonanobot.config.schema import Base
from neonanobot.security.workspace_access import current_scope_allows_loopback, current_tool_workspace
...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.deny_patterns = (deny_patterns or []) + [
            ...
            r":\(\)\s*\{.*\};\s*:",          # fork bomb
            # Block writes to neonanobot internal state files (#2989).
    ...
    def _guard_command(
        ...
        *,
        ...
        from neonanobot.security.network import contains_internal_url
