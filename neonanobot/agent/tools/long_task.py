...
``neonanobot.session.goal_state.goal_state_runtime_lines``) so compaction cannot hide them.
...
from neonanobot.agent.tools.schema import StringSchema, tool_parameters_schema
