...
from neonanobot.agent.tools.file_state import FileStates, _hash_file, current_file_states
...
from neonanobot.utils.helpers import build_image_content_blocks, detect_image_mime
...
class _FsTool(Tool):
    ...
    def create(cls, ctx: Any) -> Tool:
        from neonanobot.agent.skills import BUILTIN_SKILLS_DIR
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from neonanobot.utils.document import extract_text
