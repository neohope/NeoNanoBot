...
def runner_wall_llm_timeout_s(
    ...
    *,
    ...
    """Wall-clock cap for :class:`~neonanobot.agent.runner.AgentRunner` when streaming an LLM.
    ...
    ``metadata`` when the caller already holds :attr:`~neonanobot.session.manager.Session.metadata`
    for this turn.
    """
