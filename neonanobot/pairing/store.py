...
Persistent storage at ``~/.neonanobot/pairing.json`` keeps approved senders
...
from neonanobot.config.paths import get_data_dir
from neonanobot.utils.helpers import _write_text_atomic
