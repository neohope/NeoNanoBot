...
This directory contains built-in skills that extend neonanobot's capabilities.
...
When skills reference large local documentation or logs, prefer neonanobot's built-in
