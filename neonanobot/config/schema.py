...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from neonanobot.providers.base import GenerationSettings
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.neonanobot/workspace"
    ...
    bot_name: str = "neonanobot"  # Display name shown in CLI prompts (e.g. "{name} is thinking...")
...
class Config(BaseSettings):
    """Root configuration for neonanobot."""
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from neonanobot.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
