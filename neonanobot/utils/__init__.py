...
from neonanobot.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "neonanobot.webui.thread_disk",
    "webui_transcript": "neonanobot.webui.transcript",
    "webui_turn_helpers": "neonanobot.session.webui_turns",
}
